...
module "lambda" {
  ...
  phone_number_country = "${var.phone_number_country}"
  ...
  websms_app_url = "${var.websms_app_url}"
  websms_callback_token = "${var.websms_callback_token}"
  websms_username = "${var.websms_username}"
  websms_password = "${var.websms_password}"
  websms_gateway_url = "${var.websms_gateway_url}"
  websms_sender_address = "${var.websms_sender_address}"
  websms_sender_address_type = "${var.websms_sender_address_type}"
  websms_max_sms_per_message = "${var.websms_max_sms_per_message}"
